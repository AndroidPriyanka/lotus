...
public class Dbhelper extends SQLiteOpenHelper {
	...
	private static final String TABLE_CREATE_SCAN = "create table scan (scannedId integer primary key autoincrement,_empId text,product_type text,imagecount text,saveTime text,savedServer integer,image_desc text,latitude text , longitude text)";
	private static final String TABLE_CREATE_IMAGE = "create table image (imageId integer primary key autoincrement,scannedId integer,imagePath text not null,savedServer integer,saveTime text,image_name text,server_visiblity_id text)";
	private static final String TABLE_CREATE_ATTEDANCE = "create table attendance (id integer primary key autoincrement,emp_id text,Adate text,attendance text,absent_type text,lat text,lon text,savedServer integer,month text,holiday_desc text,year text)";
	private static final String TABLE_CREATE_STOCK = "create table stock (id integer primary key autoincrement,product_id text,db_id text,eancode text,product_category text,product_type text,product_name text, size text, price text, emp_id text,opening_stock text,stock_received text,stock_in_hand text,close_bal text,return_saleable text,return_non_saleable text,sold_stock text,total_gross_amount text,total_net_amount text,discount text,savedServer integer, insert_date text,last_modified_date text,shadeNo text default 0,month text,year text,updateDate text,db_stock_id varchar(100))";

	private static final String TABLE_CREATE_STOCK_MONTHLY = "CREATE TABLE stock_monthwise (id integer primary key autoincrement,product_id text,db_id text,eancode text,product_category text,product_type text,product_name text, size text, price text, emp_id text,opening_stock text,stock_received text,stock_in_hand text,close_bal text,return_saleable text,return_non_saleable text,sold_stock text,total_gross_amount text,total_net_amount text,discount text,savedServer integer, insert_date text,last_modified_date text,shadeNo text default 0, db_stock_id varchar(100),month_name text,year text)";

	private static final String TABLE_CREATE_TESTER = "create table tester (id integer primary key autoincrement,db_tester_id text, product_id text,db_id text,eancode text,product_category,product_type text,product_name text,size text,emp_id text,product_status text,requried_date text,delivered_date text,savedServer integer,shadeno text default 0,cat_id text)";
	...
	private static final String TABLE_PRODUCT_MASTER = "create table product_master (id integer primary key autoincrement, ProductCategory text,ProductType text,ProductName text,"
	...
	private static final String TABLE_DATE_SYNC = "create table date_sync (id integer primary key autoincrement, table_name text,date text)";
	...
	private static final String TABLE_CREATE_LOGIN = "create table login(Lid integer primary key autoincrement, username text, password text,android_uid text, created_date text,last_modified_date text ,status text, div text,flag text)";

	private static final String TABLE_CREATE_SYNC_LOG = "CREATE TABLE SYNC_LOG (ID INTEGER PRIMARY KEY, EXCEPTION,LINE_NO, METHOD,CREATED_DATE,LASTMODIFIED_DATE,USERNAME,SYNCMETHOD,RESULT,FLAG);";

//	private static final String ALTER_UPLOAD_TABLE = "ALTER TABLE image ADD server_visiblity_id varchar(128)";

	// ----------------
	private static final String TABLE_CREATE_BOC_WISE_STOCK = "create table boc_wise_stock (id integer primary key autoincrement,product_id text,db_id text,eancode text,product_category text,product_type text,product_name text, size text, price text, emp_id text,opening_stock text,stock_received text,stock_in_hand text,close_bal text,return_saleable text,return_non_saleable text,sold_stock text,total_gross_amount text,total_net_amount text,discount text,savedServer integer, insert_date text,last_modified_date text,shadeNo text default 0,month text,year text,updateDate text,db_stock_id varchar(100),date varchar(100),boc varchar(50))";
	
	private static final String TABLE_TESTER_MASTER = "create table tester_master (id integer primary key autoincrement, server_db_id text , ProductCategory text,ProductType text,ProductName text,"
