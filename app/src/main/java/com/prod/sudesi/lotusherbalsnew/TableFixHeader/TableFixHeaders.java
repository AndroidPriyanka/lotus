...
public class TableFixHeaders extends ViewGroup {
    ...
    private View makeView(final int row, final int column, int w, int h) {
        ...
        //  topNShareModelArrayList = (ArrayList<TopNShareModel>)(getContext()).getIntent().getExtras().getSerializable("Array");
       ...
       /* if (column==2) {
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                  //  final TopNShareModel topNShareModel = topNShareModelArrayList.get(row);
                   // String msg=topNShareModel.getAddress1();
                    Toast.makeText(getContext(), "row" + row + "col" + column+"modelmsg"+abcd, Toast.LENGTH_SHORT).show();
                }
            });
        }*/
