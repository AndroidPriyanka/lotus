...
public class DashboardTableAdapter<T> extends BaseTableAdapter {
    ...
    public DashboardTableAdapter(Context context) {

        this(context, null);
    }

    public DashboardTableAdapter(Context context, T[][] table) {
